...
//İleride/sonraki yerlerde veri tutarlılığı ile ilgili bir ders yapacağız.
...
class ApplicationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        #endregion
        #region ToTable
        modelBuilder.Entity<Person>().ToTable("ToTablee");
        #endregion
        #region Column
    ...
    {
        optionsBuilder.UseSqlServer("Server=Burak; Database=EF_Core_Configuration; Integrated Security=True; TrustServerCertficate=True;");
    }
}
