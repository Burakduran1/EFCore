...
var person = await context.Persons.FindAsync(201);
...
class BackingFieldDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=Burak; Database=BackingFields; Integrated Security=True;TrustServerCertificate=True;");
