...
public class ApplicationDbContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Server=Burak; Database=Seed_Data; Integrated Security= True");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Blog>()
            .HasData(
                new Blog() { Id = 1, Url = "www.burakcanduran.com " },
                new Blog() { Id = 2, Url = "weww.sdsdsd" }
            );
        modelBuilder.Entity<Post>()
            .HasData(
                new Post() { Id = 1, BlogId = 1, Content = "Yazılım", Title = "Burak Can " },
                new Post() { Id = 20, BlogId = 1, Content = "Software", Title = "Ali Rıza" }
            );
    }
}
