...
//Person person = new();
//person.Name = "Burak";
//person.Address = new Address { PersonAddress = "Malatya/Yeşilyurt" };
...
//Address address = new();
//address.PersonAddress = "Malatya/Yazıhan";
//address.Person = new Person { Name = "Ali Rıza" };
...
//Blog blog = new Blog { Name = "BurakCan.com Blog" };
